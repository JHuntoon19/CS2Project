...
public class InvoiceData {
	...
	/**
	 * Methods used for object creation Keeps this one class as the only way to
	 * access database
	 */
	/**
	 * Returns a map of persons loaded from the database
	 * 
	 * @param cf
	 * @return HashMap<UUID,Person>
	 */
	public static HashMap<UUID, Person> loadPersonsFromDatabase() {
		final Logger logger = LogManager.getLogger(InvoiceData.class);
		ConnectionFactory cf = new ConnectionFactory(logger);
	 ...
	 */
	public static HashMap<UUID, Company> loadCompaniesFromDatabase(HashMap<UUID, Person> persons) {
		final Logger logger = LogManager.getLogger(InvoiceData.class);
		ConnectionFactory cf = new ConnectionFactory(logger);
	 ...
	 */
	public static HashMap<UUID, Data> loadItemsFromDatabase() {
		final Logger logger = LogManager.getLogger(InvoiceData.class);
		ConnectionFactory cf = new ConnectionFactory(logger);
	 ...
	 */
	public static HashMap<UUID, Invoice> loadInvoicesFromDatabase(HashMap<UUID, Company> companies,
	 ...
	 * @param persons
	 */
	public static void loadInvoiceItemsFromDatabase(HashMap<UUID, Invoice> invoices, HashMap<UUID, Data> items,
			HashMap<UUID, Person> persons) {
		final Logger logger = LogManager.getLogger(InvoiceData.class);
		ConnectionFactory cf = new ConnectionFactory(logger);
		Connection conn = cf.getConnection();
